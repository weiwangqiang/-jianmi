 ...
 */
public class ResumeIntoTimeDialog implements View.OnClickListener {
    ...
    public ResumeIntoTimeDialog(Context context){
    ...
    public Dialog getEditDialog(){
        ...
        findid();
        String time =  UserControl.getUserControl().getUser().getIntoyear();
